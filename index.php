...
<head>
  ...
  <title>Online Course Review System | HOME</title>
...
<body>
  ...
  <div class="container-fluid mt-5 header" id="particle"style="background-image:url(./img/5.jpg)">
    <p class="main-text" style="margin:25px">Welcome to Online Course Review System !</p>
